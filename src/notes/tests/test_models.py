...
def test_create_note():
    ...
    note = notes.models.Note.objects.create(
        owner=user, title="Test note", content="Some text"
    )
...
def test_note_default_ordering():
    ...
    note1 = notes.models.Note.objects.create(owner=user, title="Old note")
    note2 = notes.models.Note.objects.create(owner=user, title="New note")
...
def test_note_str_representation():
    ...
    note = notes.models.Note.objects.create(owner=user, title="Readable title")
