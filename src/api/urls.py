...
urlpatterns = [
    ...
    path("auth/email/confirm/", authorization.views.ConfirmEmailView.as_view(), name="email-confirm"),
    path("auth/email/resend/", authorization.views.ResendEmailCodeView.as_view(), name="email-resend"),
