...
urlpatterns = [
    ...
    path("confirm-email/", authorization.views.ConfirmEmailPageView.as_view(), name="confirm_email"),
    path("reset-password/", authorization.views.ResetPasswordRequestPageView.as_view(), name="reset_password"),
    path("reset-password/code/", authorization.views.ResetPasswordCodePageView.as_view(), name="reset_password_code"),
